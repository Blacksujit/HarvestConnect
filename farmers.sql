...
('test', 'nirmalsujit981@gmail.com', 1, 'BAJARA', ' Tips for Growing BAJARA. Well drained medium loam and or sandy loam soils are suitable.', 520),
('test', 'nirmalsujit541@gmail.com', 2, 'COTTON', 'Cotton is a soft, fluffy staple fiber that grows in a boll,around the seeds of the cotton ', 563),
('test', 'nirmalsujit891@gmail.com', 3, 'JAAWARI', 'jawari is best business developed from pean bean for good  preparation and so on', 582);
